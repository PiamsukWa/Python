import sqlite3
conn = sqlite3.connect (r"C:\Users\ACER\Documents\Piamsuk_Python\Week6\table6.db")
c = conn.cursor()
...
def show():
    ...
    print("-"*80)
    with sqlite3.connect(r"C:\Users\ACER\Documents\Piamsuk_Python\Week6\table6.db") as con:
