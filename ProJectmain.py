...
import sqlite3
moneytype =[ 500, 100, 50, 20, 10, 5, 2, 1] #ไว้แลกเงิน
...
def insertpro():
    ...
    def data():
            ...
            c = conn.cursor()
            c.execute('CREATE TABLE IF NOT EXISTS store (ID integer PRIMARY KEY AUTOINCREMENT , Products TEXT, Price TEXT, amount TEXT NOT NULL)')
            conn.commit()
            conn.close()
    data()"""
